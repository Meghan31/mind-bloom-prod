...
async function main() {
	...
	const affirmations = [
		...
		{
			content:
				"Peace begins with a single breath — you're breathing it in now.",
			mood_type: 'Calm',
		},
		{
			content:
				'You carry tranquility within you, no matter what surrounds you.',
			mood_type: 'Calm',
		},
		{
		...
		{
			content:
				'You take the time to understand yourself — that is true wisdom.',
			mood_type: 'Reflective',
		},
		{
		...
		{
			content:
				"You are worthy of love, even when you're not feeling your best.",
			mood_type: 'Sad',
		},
		{
		...
		{
			content:
				"You're in a space of transition — that's a powerful place to be.",
			mood_type: 'Conflicted',
		},
		{
